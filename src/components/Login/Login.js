...
class Login extends Component {
    ...
    signIn = event => {
        const { erLogin, erPassword, login, password } = this.state;
    ...
    render() {
        ...
        return (
            <div>
                ...
                <br />
                <input name="password" type="password" onChange={this.onChangePassword} /> {this.state.erPassword && <label>Password must contain from 3 to 15 characters</label>}
                <br />
